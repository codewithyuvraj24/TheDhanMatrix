...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden py-16 sm:py-24">
      <FadeIn className="max-w-md w-full relative z-10">
        <div className="bg-white/70 dark:bg-white/5 backdrop-blur-2xl border border-white dark:border-white/10 rounded-3xl sm:rounded-[2.5rem] shadow-2xl overflow-hidden">
          <div className="p-6 sm:p-10 text-center border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/5">
            <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl bg-emerald-600/10 dark:bg-emerald-500/10 border border-emerald-500/20 mb-4 sm:mb-6">
              <UserPlus className="text-emerald-600 dark:text-emerald-400 w-8 h-8 sm:w-10 sm:h-10" />
            </div>
            <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight">Join the Matrix</h2>
            <p className="text-slate-500 dark:text-slate-400 text-[10px] sm:text-xs mt-2 sm:mt-3 font-bold uppercase tracking-widest leading-none">Initialize Wealth Protocol</p>
          </div>
          ...
          <div className="p-6 sm:p-10">
            ...
            <div className="flex items-center my-10">
              ...
              <span className="px-4 text-slate-400 text-[10px] font-black tracking-[0.2em] uppercase">Auth Sync</span>
              <div className="flex-1 border-t border-slate-100 dark:border-white/5"></div>
            </div>
            ...
            >
              ...
              <span>SYNC GOOGLE ID</span>
            </button>

            <div className="mt-12 text-center space-y-6">
              <p className="text-sm font-bold text-slate-500">
                Existing operative? <Link href="/login" className="text-emerald-600 dark:text-emerald-400 hover:underline">Log In</Link>
              </p>
